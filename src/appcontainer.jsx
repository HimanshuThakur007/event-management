...
import UserComp from "./components/Master/userMaster/UserComp";
import SiteCreationComp from "./components/Master/siteCreation/SiteCreationComp";
import UserRightComp from "./components/Master/userRight/UserRightComp";
import UserEventComp from "./components/Master/userEvent/UserEventComp";
import ListComp from "./components/AllLists/ListComp";
import CreatingTemplateComp from "./components/creatingTemplate/CreatingTemplateComp";
import ContactMasterComp from "./components/Master/contactMaster";
...
import EventComp from "./components/Master/evantType/EventComp";
import EventStatusComp from "./components/Master/eventStatus/EventStatusComp";
import ReviewQueComp from "./components/Master/ReviewQuestion/ReviewComp";
import MasterGroup from "./components/Master/masterGroup/MasterGroup";
import CustomerWiseReview from "./components/review/CustomerWiseReview";
...
import BirthDayReport from "./components/BirthDayReport/BirthDayReport";
    ...
    <Router>
      <div className="main-wrapper">
        ...
        <Switch>
          ...
          <Route path="/event-add" exact component={ Events } />
          <Route path="/event-list" exact component ={ EventList } />
          <Route path="/event-Details" exact component ={ EventDetails } />
          ...
          {/* --------------------master------------- */}
           ...
           <Route path='/add_user' exact component={UserComp}/>
          <Route path='/site_creation' exact component={SiteCreationComp}/>
          <Route path='/user_right' exact component={UserRightComp}/>
          <Route path='/user_event' exact component={UserEventComp}/>
          <Route path='/create_template' exact component={CreatingTemplateComp}/>
          <Route path='/user_type' exact component={UserTypeComp}/>
          <Route path='/list/:id' exact component={ListComp}/>
          <Route path='/contact_master' exact component={ContactMasterComp}/>
          <Route path='/customer_master' exact component={Customer}/>
          <Route path='/department' exact component={Department}/>
          <Route path='/purpose' exact component={PurposeComp}/>
          <Route path='/event_type' exact component={EventComp}/>
          <Route path='/event_status' exact component={EventStatusComp}/>
          <Route path='/review_que' exact component={ReviewQueComp}/>
          <Route path='/master_grp' exact component={MasterGroup}/>
          <Route path='/cust_review' exact component={CustomerWiseReview}/>
          <Route path='/whatsapp_config' exact component={WhatsAppConfigPage}/>
          <Route path='/pending_review' exact component={PendingReview}/>
          <Route path='/bday_report' exact component={BirthDayReport}/>
