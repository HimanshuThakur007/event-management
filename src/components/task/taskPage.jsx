...
const TaskPage = (props) => {
  ...
  const columns = [
    {
      ...
      render: (text, record) => (
        <span className="" style={{ color: "#800080" }}>
          {text}
        </span>
      ),
    ...
    },
    {
      title: "Due Date",
      dataIndex: "expdate",
      render: (text, record) => <span className="text-danger">{text}</span>,
  ...
  const { Name, Tmptime, Mobile, Email, Desc, UserName, ExpTime } =
    props.inputValue;
  return (
    <>
                ...
                <div className="card-body">
                  ...
                  <div className="table-responsive">
                    <Table
                      ...
                      pagination={{
                        total: props.templateList.length,
                      ...
                      <div className="form-group row">
                        <div className="col-sm-6">
                          ...
                          <img
                            ...
                            alt="img"
                            style={{ width: "23vh", marginTop: "3vh" }}
                          />
                          ;
                        </div>
