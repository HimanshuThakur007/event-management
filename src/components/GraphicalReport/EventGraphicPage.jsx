  ...
  return (
    <div className="page-wrapper">
      ...
      <div className="content container-fluid">
        <div className="crms-title row bg-white mb-4">
          <div className="col">
            <h3 className="page-title">
              ...
              <span>Event Graphical Report</span>
            </h3>
          </div>
        ...
        {props.feedBackGraph != undefined && props.feedBackGraph.length > 0 ?(
        ...
        <div className="row graphs mt-3">
          <div className="col-md-12">
            <div className="card h-100">
              <div className="card-body">
                {props.feedBackGraph && props.feedBackGraph != null && props.feedBackGraph != undefined &&
              ...
              <div className="card-body">
                {props.feedBackGraph &&
                  props.feedBackGraph.map((items, ind) => {
                    return (
                      <>
                        {items.eventWiseGraficReport.map((obj, i) => {
                          return (
                            <>
                              <GraphCard
                              ...
                              <div className="col-12 d-flex flex-wrap">
                                {obj.quesWiseGraficReport !== null && obj.quesWiseGraficReport.map(
                                  (items, index) => {
                                    return (
...
export default EventGraphicPage;
