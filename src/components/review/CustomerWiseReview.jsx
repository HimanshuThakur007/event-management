...
setEventCode(0)
setTableDataList([])
    let eventUrl = `/api/ReportsCustWise?Code=${tempCode||enevtCode||0}&Type=${typeCode}&Site=${siteCode}&SDate=${sdate}&EDate=${edate}`;
  ...
  const handleExportClick = () => {
    ...
    excel
      ...
      .saveAs("CustomerWiseReview.xlsx");
  };
...
const getSiteList = async () => {
  ...
  return (
    <div className="page-wrapper">
        <ReactToast/>
      <Helmet>
        <title>Customer Report - Event&Management</title>
        ...
        <div className="crms-title row bg-white mb-0">
          <div className="col p-0">
            <h3 className="page-title">
              ...
              </span> Customer Wise Review
            </h3>
          </div>
          <div className="col p-0 text-end">
            <ul className="breadcrumb bg-white float-end m-0 pl-0 pr-0">
              <li className="breadcrumb-item"><Link to="/">Dashboard</Link></li>
              <li className="breadcrumb-item active">Customer Wise Review</li>
            </ul>
          </div>
        </div>
        {/* Page Header Second */}
...
export default CustomerWiseReview;
